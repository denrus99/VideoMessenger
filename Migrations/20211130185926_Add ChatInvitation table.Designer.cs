...
namespace VideoMessenger.Migrations
{
    ...
    [Migration("20211130185926_Add ChatInvitation table")]
    partial class AddChatInvitationtable
    {
            ...
            modelBuilder.Entity("VideoMessenger.Models.Chat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            ChatName = "RI-390003",
                            CreationDate = new DateTime(2021, 11, 30, 23, 59, 25, 800, DateTimeKind.Local).AddTicks(4686)
                        },
                        new
                        {
                            Id = -2,
                            ChatName = "Gamers Room",
                            CreationDate = new DateTime(2021, 12, 2, 23, 59, 25, 801, DateTimeKind.Local).AddTicks(7346)
                        });
                });
            ...
            modelBuilder.Entity("VideoMessenger.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            ChatId = -1,
                            CreationDate = new DateTime(2021, 11, 30, 23, 59, 25, 801, DateTimeKind.Local).AddTicks(9294),
                            Data = "Hello, World!",
                            IsReaded = false,
                            SenderId = -1
                        },
                        new
                        {
                            Id = -2,
                            ChatId = -2,
                            CreationDate = new DateTime(2021, 12, 2, 23, 59, 25, 801, DateTimeKind.Local).AddTicks(9831),
                            Data = "Good bye, World!",
                            IsReaded = true,
                            SenderId = -2
                        },
                        new
                        {
                            Id = -3,
                            ChatId = -2,
                            CreationDate = new DateTime(2021, 12, 1, 2, 59, 25, 801, DateTimeKind.Local).AddTicks(9842),
