...
namespace VideoMessenger.Migrations
{
    ...
    [Migration("20211130161340_Add Roles And Test Data")]
    partial class AddRolesAndTestData
    {
            ...
            modelBuilder.Entity("VideoMessenger.Models.Chat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            ChatName = "RI-390003",
                            CreationDate = new DateTime(2021, 11, 30, 21, 13, 40, 34, DateTimeKind.Local).AddTicks(1534)
                        },
                        new
                        {
                            Id = -2,
                            ChatName = "Gamers Room",
                            CreationDate = new DateTime(2021, 12, 2, 21, 13, 40, 35, DateTimeKind.Local).AddTicks(4183)
                        });
                });
